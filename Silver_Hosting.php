			...
			<div id="content">
				...
				<form method="post" action="" class="cart">
					<fieldset>
						...
						<input type="hidden" name="my-item-name" value="Silver Hosting Plan" />
						<input type="hidden" name="my-item-price" value="2000.00" />
						<input type="hidden" name="my-item-url" value="" />

						<ul>
							<li><strong>Silver Hosting Plan</strong></li>
